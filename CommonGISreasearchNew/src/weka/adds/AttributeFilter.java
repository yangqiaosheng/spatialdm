 ...
 */
public class AttributeFilter extends Filter2 implements OptionHandler {
	...
	public boolean input(Instance instance) {
		...
		copyStringValues(inst, false, instance.dataset(), m_InputStringIndex, getOutputFormat(), getOutputStringIndex());
	...
	public static void main(String[] argv) {
		...
		try {
			if (Utils.getFlag('b', argv)) {
				Filter2.batchFilterFile(new AttributeFilter(), argv);
			} else {
				Filter2.filterFile(new AttributeFilter(), argv);
			}
		} catch (Exception ex) {
