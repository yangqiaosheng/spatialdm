...
public class AttributeSelectionPanel extends JPanel {
				...
				public void run() {
					...
					try {
						...
						if (evaluator instanceof AttributeTransformer) {
							...
							try {
								Instances transformed = ((AttributeTransformer2) evaluator).transformedData();
	...
	public static void main(String[] args) {
		...
		try {
			final javax.swing.JFrame jf = new javax.swing.JFrame("Weka Knowledge Explorer: Select attributes");
			jf.getContentPane().setLayout(new BorderLayout());
