...
public class AssociationsPanel extends JPanel {
	...
	static {
		...
		java.beans.PropertyEditorManager.registerEditor(weka.associations.Associator.class, weka.gui.GenericObjectEditor.class);
	}
	...
	public static void main(String[] args) {
		...
		try {
			final javax.swing.JFrame jf = new javax.swing.JFrame("Weka Knowledge Explorer: Associator");
