...
public class AttributeTypes {
	...
	*/
	public static final char integer = types[0], real = types[1], character = types[2], logical = types[3], time = types[4], geometry = types[5];
	/**
	...
	*/
	public static final int original = 0, compute = 1, sum = 2, difference = 3, ratio = 4, ratio_in_sum = 5, ratio_in_const = 6, percent = 7, percent_in_sum = 8, percent_in_const = 9, change_ratio = 10, change_percent = 11, average = 12,
			variance = 13, value_count = 14, classify = 15, classify_order = 16, classify_dominant = 17, classify_similar = 18, evaluate_score = 19, evaluate_rank = 20, order = 21, distance = 22, dominance_degree = 23, percentile = 24;
