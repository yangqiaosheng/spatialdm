 ...
 */
public class SimilarityExplorer extends BaseAnalyser {
	/**
	 * The register of the available tools
	 */
	protected SimilarityToolsRegister toolReg = new SimilarityToolsRegister();
	/**
	...
	*/
	...
	public void run(ESDACore core) {
		if (core == null || core.getUI() == null)
			return;
		this.core = core;
		SelectDialog selDlg = new SelectDialog(core.getUI().getMainFrame(), "Similarity analysis", "Select the operation:");
