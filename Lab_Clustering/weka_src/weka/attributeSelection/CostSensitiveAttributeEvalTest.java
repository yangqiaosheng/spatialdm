 ...
 */
public class CostSensitiveAttributeEvalTest extends AbstractEvaluatorTest {
	...
	public ASEvaluation getEvaluator() {
		...
		// load cost matrix
		try {
			csse.setCostMatrix(new CostMatrix(new InputStreamReader(ClassLoader.getSystemResourceAsStream("weka/classifiers/data/ClassifierTest.cost"))));
		} catch (Exception e) {
			e.printStackTrace();
		}
