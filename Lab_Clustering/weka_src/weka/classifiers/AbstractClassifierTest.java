...
public abstract class AbstractClassifierTest extends TestCase {
	...
	protected CheckOptionHandler getOptionTester() {
		...
		result.setOptionHandler(getClassifier());
	...
	public void testRegression() throws Exception {
		...
		for (i = FIRST_CLASSTYPE; i <= LAST_CLASSTYPE; i++) {
			...
			train = m_Tester.makeTestDataset(42, m_Tester.getNumInstances(), m_NominalPredictors[i] ? m_Tester.getNumNominal() : 0, m_NumericPredictors[i] ? m_Tester.getNumNumeric() : 0, m_StringPredictors[i] ? m_Tester.getNumString() : 0,
					m_DatePredictors[i] ? m_Tester.getNumDate() : 0, m_RelationalPredictors[i] ? m_Tester.getNumRelational() : 0, 2, i, m_multiInstanceHandler);
