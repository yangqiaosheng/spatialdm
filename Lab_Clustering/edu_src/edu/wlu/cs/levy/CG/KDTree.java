...
public class KDTree<T> {
	...
	*/
	...
	public List<T> nearestGeo(double[] key, double dist) throws KeySizeException {
		return nearestDistance(key, dist, new GeoDistance());
	}

	public List<T> nearestTemp(double[] key, double dist) throws KeySizeException {
		return nearestDistance(key, dist, new TempDistance());
	}
