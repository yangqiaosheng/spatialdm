    ...
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R10000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_10000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R160000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_160000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R20000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_20000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R320000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_320000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R40000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_40000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R5000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_5000_ID");
    create index "GENNADY_FLICKR"."FLICKR_EUROPE_R80000_ID_IDX" on "GENNADY_FLICKR"."FLICKR_EUROPE"("TAKEN_DATE" desc, "REGION_80000_ID");