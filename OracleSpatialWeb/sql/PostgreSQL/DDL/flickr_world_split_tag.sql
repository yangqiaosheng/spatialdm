...
-- DROP TABLE flickr_world_split_tag;

CREATE TABLE flickr_world_split_tag
(
  ...
  CONSTRAINT flickr_world_split_tag_pkey PRIMARY KEY (photo_id, tag),
  CONSTRAINT flickr_world_split_tag_photo_id_fkey FOREIGN KEY (photo_id)
...
ALTER TABLE flickr_world_split_tag OWNER TO gennady_flickr;
