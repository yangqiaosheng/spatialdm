    ...
    create table FLICKR_WORLD(
     ...
     create index FLICKR_WORLD_R2560000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_2560000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R1280000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_1280000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R640000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_640000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R320000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_320000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R160000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_160000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R80000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_80000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R40000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_40000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R20000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_20000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R10000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_10000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R5000_ID_IDX
     	on FLICKR_WORLD
     	(REGION_5000_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R2500_ID_IDX
     	on FLICKR_WORLD
     	(REGION_2500_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R1250_ID_IDX
     	on FLICKR_WORLD
     	(REGION_1250_ID, TAKEN_DATE desc);

     create index FLICKR_WORLD_R625_ID_IDX
     	on FLICKR_WORLD
