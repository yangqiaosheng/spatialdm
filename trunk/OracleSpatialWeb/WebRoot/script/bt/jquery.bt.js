  ...
  jQuery.fn.bt = function(content, options) {
    ...
    return this.each(function(index) {
      ...
      this.btOn = function () {
        ...
        var canvas = $('<canvas width="'+ (numb($text.btOuterWidth(true)) + opts.strokeWidth*2) +'" height="'+ (numb($text.outerHeight(true)) + opts.strokeWidth*2) +'"></canvas>').appendTo($box).css({position: 'absolute', top: $text.btPosition().top, left: $text.btPosition().left, zIndex: opts.boxzIndex}).get(0);
      ...
      this.btOff = function() {
        ...
        if (typeof contentOrig == 'object') {
          ...
          $(contentOrig).data(arrayRemove(clones, contentOrig.clone));
        }
