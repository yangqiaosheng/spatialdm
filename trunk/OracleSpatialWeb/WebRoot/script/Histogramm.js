...
Histogramm.prototype.render1 = function(parent, arrayX) {
	...
	for ( var i = 0; i < this.model.getNumberOfClasses(); i++) {
		...
		if (i == this.model.getNumberOfClasses() - 1) {
			information.innerHTML = " <div><input type='button' class='histogramInfoButton' onclick='javascript:mirrorAllYear();'></div>";
...
Histogramm.prototype.render2 = function(parent, arrayX) {
	...
	for ( var i = 0; i < this.model.getNumberOfClasses(); i++) {
		...
		parent.appendChild(both);
		if (i == this.model.getNumberOfClasses() - 1) {
			information.innerHTML = "<div><input type='button' class='histogramInfoButton' onclick='javascript:mirrorAllMonths();'></div>";
			parent.appendChild(information);
		}
	}
};
...
Histogramm.prototype.render3 = function(parent, arrayX) {
	...
	for ( var i = 0; i < this.model.getNumberOfClasses(); i++) {
		...
		parent.appendChild(both);
		if (i == this.model.getNumberOfClasses() - 1) {
			information.innerHTML = "<div><input type='button' class='histogramInfoButton' onclick='javascript:mirrorAllDays();'></div>";
			parent.appendChild(information);
		}
	}
};
...
Histogramm.prototype.render4 = function(parent, arrayX) {
	...
	for ( var i = 0; i < this.model.getNumberOfClasses(); i++) {
		...
		parent.appendChild(both);
		if (i == this.model.getNumberOfClasses() - 1) {
			information.innerHTML = "<div><input type='button' class='histogramInfoButton' onclick='javascript:mirrorAllHours();'></div>";
			parent.appendChild(information);
		}
	}
};
...
Histogramm.prototype.render5 = function(parent, arrayX) {
	...
	for ( var i = 0; i < this.model.getNumberOfClasses(); i++) {
		...
		parent.appendChild(both);
		if (i == this.model.getNumberOfClasses() - 1) {
			information.innerHTML = "<div><input type='button' class='histogramInfoButton'  onclick='javascript:mirrorAllWeekDays();'></div>";
			parent.appendChild(information);
		}
	}
};
