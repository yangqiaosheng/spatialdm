...
import de.fraunhofer.iais.spatial.web.servlet.ZoomKmlServlet;
...
public class CleanOldKmlsTimerTask extends TimerTask {
	...
	public void run() {
		...
		try {
			...
			File kmlPath = new File(this.getClass().getResource(SystemUtils.getUserHome() + ZoomKmlServlet.kmlPath).getPath());
